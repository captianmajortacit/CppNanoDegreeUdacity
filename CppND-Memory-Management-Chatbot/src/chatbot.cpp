...
{
    std::cout<<"ChatBot Copy Assignment Constructor: ASSIGNING content of instance " <<&source<<" to instance "<<this<<std::endl;
    if(this == &source)
        return *this;
    _currentNode = source._currentNode;
    _rootNode    = source._rootNode;
...
{
    std::cout<<"ChatBot Move Constructor: MOVING content of instance " <<&source<<" to instance "<<this<<std::endl;
    _currentNode = source._currentNode;
    _rootNode    = source._rootNode;
    _chatLogic   = source._chatLogic;
    ...
    //Clearing the source pointer to null ptr
...
{
    std::cout<<"ChatBot Move Assignment Constructor: ASSIGNING content of instance " <<&source<<" to instance "<<this<<std::endl;
    if(this == &source)
        return *this;
    if(_image != nullptr)
        delete _image;
